...
float alpha = edgeFade * 0.6 * atten;
      ...
      `}),c=new jt(new bi(r*2,r*2),o);n.add(c);const l=()=>{const _=e.clientWidth,v=e.clientHeight;t.setSize(_,v,!1),a.uRes.value.set(_,v)};l(),window.addEventListener("resize",l);const f=new rc;let h=0;const d=()=>{h=requestAnimationFrame(d),a.uTime.value=f.getElapsedTime(),t.render(n,s)};return d(),()=>{cancelAnimationFrame(h),window.removeEventListener("resize",l),n.remove(c),o.dispose(),t.dispose(),e.removeChild(t.domElement)}},[]),Go.jsx("div",{"code-path":"src\\components\\three\\AnimatedBackground.tsx:196:7",ref:i,className:"w-full h-[100%]"})}export{ip as default};
